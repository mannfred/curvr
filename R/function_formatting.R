#' Convert polynomial objects from \code{Momocs} into expressions.
#'
#' Convert polynomial objects from \code{Momocs} into expressions
#' for computing derivatives by \code{stats::deriv3()}.
#'
#' @param poly A \code{list} object generated by \code{Momocs::npoly()} or
#'    \code{Momocs::opoly()}. This function does not currently support \code{OpnCoe} objects.
#'
#' @param expr Indicate whether you want a string or expression returned.
...
#'     \code{Momocs::opoly()}. This function does not currently support \code{OpnCoe} objects.
#'
#' @return a polynomial function (eg y = x^2) of the form \code{function(x) {x^2}}.
#'
#'
#'
#' @examples
